  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <header className="text-right text-sm text-text-secondary-light dark:text-text-secondary-dark space-y-2 mb-20">
        <p>홍익대학교 디자인학부 DEEP Lab</p>
        <p>서울시 마포구 와우산로 94, 홍익대학교 홍문관 1201</p>
        <div className="flex items-center justify-end space-x-4 mt-2">
          <a className="flex items-center space-x-1 hover:underline" href="mailto:ryun@hongik.ac.kr">
            <span className="material-symbols-outlined text-base">mail</span>
            <span>ryun@hongik.ac.kr</span>
          </a>
          <a className="flex items-center space-x-1 hover:underline" href="https://instagram.com/deeplab.hongik" rel="noopener noreferrer" target="_blank">
            <svg aria-hidden="true" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              <path clipRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.024.06 1.378.06 3.808s-.012 2.784-.06 3.808c-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.024.048-1.378.06-3.808.06s-2.784-.012-3.808-.06c-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.048-1.024-.06-1.378-.06-3.808s.012-2.784.06-3.808c.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 016.08 2.525c.636-.247 1.363-.416 2.427-.465C9.53 2.013 9.884 2 12.315 2zm-1.002 6.363a4.95 4.95 0 100 9.9 4.95 4.95 0 000-9.9zM12 15.437a3.437 3.437 0 110-6.874 3.437 3.437 0 010 6.874z" fillRule="evenodd"></path>
              <path d="M16.838 7.222a1.237 1.237 0 100 2.474 1.237 1.237 0 000-2.474z"></path>
            </svg>
            <span>instagram.com/deeplab.hongik</span>
          </a>
        </div>
      </header>
      <main>
        <section className="mb-24">
          <h1 className="text-8xl font-bold text-primary dark:text-white">DEEP Lab</h1>
          <p className="text-4xl mt-2 text-text-light dark:text-text-dark">DEsign Experience for People</p>
        </section>
        ...
        <section className="max-w-4xl mx-auto mb-24 text-base leading-relaxed space-y-6">
          <p>홍익대학교 DEEP 랩은 Design Experience for People의 약자로 '사람들에게 좋은 경험을 제공할 수 있도록 깊이 연구하여 좋은 디자인을 만들겠다' 라는 바램과 가치관이 담겨있습니다. DEEP 랩에서 집중하고 있는 연구분야로는 면밀한 사용자 조사를 기반으로 한 UX·UI 연구, 사용자의 행동을 유도하고 기만하는 Persuasive 디자인 연구, 수집된 데이터를 시각화하여 인사이트를 제공하는 Data Visualization 연구, 인공지능 솔루션을 효과적으로 사용할 수 있도록 도와주는 AI Interaction Design 연구 등으로 구성되어 있습니다.</p>
          <p>DEEP 랩은 '디자인만 하고 싶은 사람이 아닌, '사람에 대한 관심이 많은 사람들'로 구성되어 있습니다. 보기 좋게 만들고, 사용하기 편리하게 만드는 것을 디자인이라 생각할 수 있지만, 정교하게 설계된 디자인은 기술과 사람을 바람직하게 연결해 주며 궁극적으로 사용자의 행동을 긍정적으로 유도하기도 합니다. DEEP 랩은 사람에 대한 이해와 열정을 바탕으로 지속적으로 연구하고자 합니다.</p>
        </section>
        ...
        <section className="mb-32">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center md:items-start">
              <img alt="Portrait of Professor Yoon Jae-Young" className="w-48 h-48 rounded-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDC_w6i2BlGgFZUb7DJrMqWcTBcgtqGoke05AoCkgfv_nbyvgAZhev0HVsRyDVU9q5QfTJwzxhv579SzUX1RiXh6gvqy3D9x-Ib5N2ybkPotW5S1KsF38Xoq7_xMSt31GEekjNTgpAeAsRJY5pCgVOBPrUWc8G5h303RKxiPFxcp2j5HPiZJsQFuaexYeNypj_sCzF430GDnUK8DICSZtWZEhi9WUJZWmG6dO66UqZdv7mMkPB4JiENYwDx5KZom5YweY6Vzeqk18"/>
              <h2 className="text-lg font-bold mt-4">윤재영 교수 (부교수)</h2>
              <a className="text-sm underline" href="mailto:ryun@hongik.ac.kr">ryun@hongik.ac.kr</a>
            </div>
            <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <ul className="space-y-1 text-sm">
                  <li>홍익대학교 디자인학부 시각디자인과 교수</li>
                  <li>홍익대학교 영상·커뮤니케이션대학원 인터랙션디자인전공 전공주임</li>
                  <li>홍익대학교 일반대학원 영상·인터랙션학과 교수</li>
                  <li className="pt-4">Carnegie Mellon University, Computational Design 박사</li>
                  <li>Carnegie Mellon University, Human Computer Interaction 석사</li>
                  <li>Carnegie Mellon University, Tangible Interaction Design 석사</li>
                  <li>Rhode Island School of Design, Graphic Design 학사</li>
                  <li className="pt-4">동아비지니스리뷰(DBR) 필진</li>
                  <li>한국디자인학회 부회장, 논문편집위원</li>
                  <li>한국HCI학회 이사, 프로그램위원장(2018, 2021)</li>
                  <li>디자인융합학회 부회장, 논문편집위원</li>
                  <li>한국국제문화학회 국제학술대회 조직위원장 (2021)</li>
                </ul>
              </div>
              <div>
        ...
        <section className="mb-32">
          <div className="mb-16">
            <h2 className="text-2xl font-bold mb-8">박사과정 연구원</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-10">
              <div className="flex items-center space-x-4">
                <img alt="Portrait of a lab member" className="w-16 h-16 rounded-full object-cover flex-shrink-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCoFPmynTP4fD94dbeQAg6pfF9Fj-PTtsLi9git2r12o1v3zVNed30ES24tAvUqWIbQQgWLChU4p6O7ZfC-2hD4AyTspbNCZC-F-GJ4KHkyK0YHtSKcXKAPBmqTJdq--zt4QZZFbnlUUVr0Icmt2dSbr0W7j54VxmbbCxKVIze7mGyVs6dHpJlsK23IyNY_64rKZ_xVxK_nSW2SbGcCUsGP0XrZ4iC1wZDx8k2qim8qNKlP52bCKt-ScCAI0zrliBkyhu2vdiW2NLQ"/>
                <div>
                  <p className="font-bold">박해랑</p>
                  <p className="text-xs text-text-secondary-light dark:text-text-secondary-dark">사용자 행동변화 디자인, 다크패턴 UX 디자인</p>
                  <a className="text-xs underline break-all" href="mailto:yerang.parki@gmail.com">yerang.parki@gmail.com</a>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <img alt="Portrait of a lab member" className="w-16 h-16 rounded-full object-cover flex-shrink-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuANdgTouCFsrgrRL-_s_LltbqhDpBd3z2cGFj0P_bmKmdJ-fpcWKiqj5BH3Z8fkaawNoVVrxdh_dNUi9rlLHgaLSXibN7ykeU5VK27PV8Y1Ty_BPvLAvdklcfo_qz6H6415FjFnB4W18sB87U10lYnjxlr_wHVRdCGpeDHmiJOnXyo-RLs72P1bDmaK1swuvSsRUGKQocUjOwMNSMC2KQpX5-4CEEkjKHaoKJy3r5o6qRXsIJ63YE4Z0V5Ux1MsVUTZk9RZ_npljJk"/>
                <div>
                  <p className="font-bold">정은선</p>
                  <p className="text-xs text-text-secondary-light dark:text-text-secondary-dark">UX디자인, 인터랙션디자인, 데이터 시각화</p>
                  <a className="text-xs underline break-all" href="mailto:aesun1015@gmail.com">aesun1015@gmail.com</a>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <img alt="Portrait of a lab member" className="w-16 h-16 rounded-full object-cover flex-shrink-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC3kVktNCxJRutVfoDNDBUEjWSYuwGWrVvsdBjxDwAWKDSHHIsPm9d1yWBlZuz2WR6wtlijmrnm9YSZfSCjQdfkztExzdtp20J7xz1H8yWY72KLmrLpDIwL7NQcNA6wz9bZLNCdbsot6qQ2h6IK75kx2fjN2o8aNXDiw4ZMbb27YUMfm7iP2QIUhVGYSueRIVSMrRYmTe7zJwvUlLV8dSVMwqmzL4jNYzLGFk9TsYMk4Oz-yzS3Jwppmq9exawcZ4EZzKHahDylFms"/>
                <div>
                  <p className="font-bold">안지선</p>
                  <p className="text-xs text-text-secondary-light dark:text-text-secondary-dark">UX디자인, 인공지능 스피커 성격</p>
                  <a className="text-xs underline break-all" href="mailto:jan@g.hongik.ac.kr">jan@g.hongik.ac.kr</a>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <img alt="Portrait of a lab member" className="w-16 h-16 rounded-full object-cover flex-shrink-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBmoLGq83iEUWW6yAbXX5vTTsLsrC8x6WG9PDIAPnQOx54Zk_1RNRBQ4qMN4i46tV4lgsk_pVNapQw3pqVgRDYonMZBUIjrTuCCSwyo2mZ0sljZdjmXi6J2MDVPfmUQym1p70Ji-hiZf77X2ww-gRE3EnNlGY2KvqIZfbDNhTUimiaDcZ8za1zG6LSSfCUALlNrC_aFSNdCyRv2Uq8rolIek8mWqKEV0KUdh6X0QiAwz3jht4eVu2TGqSFnnaIp8FpLpwOgQ7raXLk"/>
                <div>
                  <p className="font-bold">신원택</p>
                  <p className="text-xs text-text-secondary-light dark:text-text-secondary-dark">(느린)인터랙션, 미디어아트, 인지과학</p>
                  <a className="text-xs underline break-all" href="mailto:shin@wonbaek.de">shin@wonbaek.de</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">졸업생</h2>
            <div className="text-sm space-y-2 text-text-secondary-light dark:text-text-secondary-dark">
              <p><strong className="text-text-light dark:text-text-dark font-normal">박사</strong><br/>김정기(2024), 김나연(2023), 신민아(2021), 박윤하(2021), 장순규(2020)</p>
              <p><strong className="text-text-light dark:text-text-dark font-normal">석사</strong><br/>김동유, 송은정, 유지수, 정다영, 김혜수, 김세현, 이혜인, 김미미, 유희준, 윤수진, 오현근, 강동효, 이현솔, 서유주, 신지연, 이시은, 김병년, 이경아, 구보람, 배미영, 정유진 (2024)</p>
            </div>
          </div>
        </section>
        <section className="mb-32">
      ...
      <footer className="bg-primary dark:bg-black py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs text-gray-400">Copyright © 2021 Hongik University DEEP laboratory</p>
        </div>
      </footer>
    </div>
  );
